...
منسّق وكلاء البرمجة المستقل الذي يعمل فوق [OpenCode](https://github.com/opencode-ai/opencode) و [Beads](https://github.com/beads-project/beads). حدد الهدف، اذهب لشؤونك، وعُد لتجد فرعاً جاهزاً بالاختبارات الناجحة.
...
| **Beads CLI** (`bd`) | متتبع المهام | [github.com/beads-project/beads](https://github.com/beads-project/beads) |
